...
public class Generator {
    ...
    public static void main(String[] args) {
        Generator.generateByTables (false,"com.sans.core"
                ,"cbw", "idle","role");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
       ...
       // mpg.setTemplateEngine(new FreemarkerTemplateEngine ());
        ...
        String dbUrl = "jdbc:mysql://127.0.0.1:3306/" + database + "?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true";
        ...
        config.setActiveRecord(false)
                .setAuthor(author)
                .setOutputDir("D:\\Projects\\spring-boot-security-demo\\src\\main\\java")

...
public class SwaggerConfig {
    ...
    // 设置默认TOKEN，方便测试
    private static final String TOKEN =null; //"Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ6aGFveGluZ3VvLVtST0xFX0FETUlOLCBBVVRIX1dSSVRFXSIsImV4cCI6MTUzOTMzOTM0NX0.P9dkLQ7lpNODJppHBM-InSS90nw0XJieK8QNlZM0TeuNNQ8sUPYH-uif099A1-P2Ap6b_9lCLbXL2iR0OLdFyw";
    ...
    public Docket api() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sans.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "API TOS",
                "Terms of service",
                new Contact("Cheng bowen", "https://str0ngercheng.github.io/", "2442799764@qq.com"),
